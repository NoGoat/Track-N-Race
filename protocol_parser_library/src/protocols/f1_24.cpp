...
// All-driver field layouts: supplied f1-24-v27.2x.md,
    ...
    switch (hdr.packetId) {
            ...
            if (length >= HEADER_SIZE + 22 * damageSize) {
                ...
                for (int i = 0; i < 22; ++i) {
                    ...
                    if (hot.hasPrivateTelemetry(i, hdr.playerCarIndex)) {
                        ...
                        car.wing_fl = data[cBase + 24]; car.wing_fr = data[cBase + 25]; car.wing_rear = data[cBase + 26];
        ...
        case PID_PARTICIPANTS: {
            ...
            for (int i = 0; i < std::min(pr.num_active_cars, 22); ++i) {
                ...
                const auto accessValue = data[nameStart + 48];
