...
// Build-time gate; also applies to electron-vite's on-demand dev compilation.
const includePairDiagnostics = process.env.INCLUDE_PAIR_DIAGNOSTICS === '1'
...
export default defineConfig({
  main: {
    define: {
      ...
      __ENABLE_PAIR_DIAGNOSTICS__: JSON.stringify(includePairDiagnostics)
    },
