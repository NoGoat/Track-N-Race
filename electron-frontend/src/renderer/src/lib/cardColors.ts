...
export function tokenColor(token: string, isDark: boolean): string | undefined {
  switch (token) {
    ...
    case 'warn':           return isDark ? '#d4ad04' : '#8B5200'
    case 'warnAlt':        return isDark ? '#c47d0e' : '#A04300'
    case 'info':           return isDark ? '#5794F2' : '#0B57D0'
    case 'ice':            return isDark ? '#5794F2' : '#0B57D0'
    case 'mguk':           return isDark ? '#FADE2A' : '#765900'
    case 'fuel':           return isDark ? '#F0A500' : '#A04300'
    case 'off':            return isDark ? 'var(--text-secondary)' : '#565B70'
    case 'wear1':          return isDark ? '#73BF69' : '#137333'
    case 'wear2':          return isDark ? '#A8D436' : '#5F7418'
    case 'wear3':          return isDark ? '#FF9830' : '#A04300'
