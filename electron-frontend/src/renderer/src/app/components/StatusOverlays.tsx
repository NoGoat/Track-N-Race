    ...
    <>
      {isScanning && (
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[var(--bg-modal)] backdrop-blur-sm">
          ...
          <div className="w-64 h-1.5 bg-[var(--border)] rounded-full overflow-hidden relative"><div className="absolute inset-y-0 left-0 bg-[var(--color-info)] w-1/2 rounded-full animate-bounce" style={{ animation: 'scan 1.5s infinite linear' }} /></div>
      ...
      {exportState === 'busy' && (
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[var(--bg-modal)] backdrop-blur-sm">
          ...
          <div className="w-64 h-1.5 bg-[var(--border)] rounded-full overflow-hidden relative"><div className="absolute inset-y-0 left-0 bg-[var(--color-info)] rounded-full transition-[width] duration-150 ease-linear" style={{ width: `${progress}%` }} /></div>
