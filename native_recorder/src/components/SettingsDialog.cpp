...
QWidget* SettingsDialog::buildAboutPage() {
    ...
    const Lib libs[] = {
        ...
        { "zlib",          "1.3.1",    "zlib",    "© 1995–2024 Jean-loup Gailly & Mark Adler", "https://zlib.net",              "zlib.net",        ":/licenses/Zlib.txt"     },
        ...
        { "KDE Frameworks",        "6.27.0", "LGPL v2.1+", "© KDE contributors",                         "https://invent.kde.org/frameworks",              "invent.kde.org", ":/licenses/LGPL-2.1.txt" },
#endif
    };
